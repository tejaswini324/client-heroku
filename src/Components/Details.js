...
class Details extends React.Component{
    ...
    componentDidMount (){
        ...
        axios({
            url: `http://floating-plains-66390/restaurantdetails/${restaurantId}`,
            method:"GET",
    ...
    handleOrder= () => {
        ...
        axios({
            url: `http://floating-plains-66390/menuItems/${restaurantId}`,
            method:"GET",
            Headers:{'Content-Type': 'application/json'}
         }).then(response =>{
    ...
    getData = (data) => {
        return fetch(`http://floating-plains-66390/payment`, {
            method: "POST",
            headers: {
